...
-- LSP
vim.keymap.set("n", "K", function() if lsp_attached() then vim.lsp.buf.hover() end end)
vim.keymap.set("n", "<leader>t", function() if lsp_attached() then vim.lsp.buf.hover() end end)
...
vim.keymap.set("n", "gr", function() if lsp_attached() then vim.lsp.buf.references() end end)
vim.keymap.set("n", "<leader>a", function() if lsp_attached() then vim.lsp.buf.code_action() end end)
